...
class TB_Public {
    ...
    private function get_js_config() {
        return [
            ...
            'enableCash'           => (bool) TB_Settings::get('tb_enable_cash'),
            'enableStripe'         => (bool) TB_Settings::get('tb_enable_stripe'),
            'enablePaypal'         => (bool) TB_Settings::get('tb_enable_paypal'),
            ...
            'contact'              => [
                ...
                'email'    => TB_Settings::get_translated('tb_contact_email'),
                'whatsapp' => TB_Settings::get_translated('tb_contact_whatsapp'),
            ],
            'transferTypes'        => [
